...
let weightPet:Double = 3.5
print("Вага хатньої тварини:\(weightPet) кг")

let yearsPet = 4
print("Вік хатньої тварини:\(yearsPet) років")
...
var userName = "Alex"
var userSurname = "Ivanov"
var userAge = 25
var userHeight:Double = 180.0
var userWeight:Double = 70.0
